...
class KategoriController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($kategori) {
            return redirect()->route('kategori.index')->with('update', 'Data kategori berhasil diupdate');
        } else {
            return redirect()->route('kategori.index')->with('error', 'Data kategori gagal ditambahkan');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        $kategori->delete();
        if ($kategori) {
            return redirect()->route('kategori.index')->with('delete', 'Data kategori berhasil dihapus');
        } else {
